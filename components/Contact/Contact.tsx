...
const Contact = () => {
  ...
  return (
    <div
      id="contact"
      className={`relative bg-white min-h-[500px] pb-[150px] w-full flex flex-row justify-center items-center relative overflow-visible`}
    >
      <div
        className={`${styles.clipped} absolute top-0 left-0 right-0 overflow-visible`}
      ></div>
      <div
      ...
      >
        <div className="mx-auto">
          <Title title={t.ctaTitle} className="text-goldBg mb-[10px] mx-auto" />
        </div>
        <div className="mx-auto">
