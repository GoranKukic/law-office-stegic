    ...
    <div className=" bg-footer-gradient flex justify-center items-center flex flex-col overflow-hidden !important">
      <div className="h-full bg-lightBlack max-w-[1172px] w-full">
        <div className=" w-full mx-auto my-[55px] px-4 z-20">
          ...
          <div className="flex flex-col gap-[35px] md:gap-[0px] md:flex-row">
            ...
            <div className="max-w-[210px] w-full px-2">
              <div>
                <ul className=" flex flex-col gap-[15px] md:gap-[25px] text-[16px] font-normal text-footerText font-['Open Sans'] leadeing-[155%]">
                  <li>
            ...
            <div className="max-w-[290px] w-full px-2">
              <ul className='flex flex-col gap-[15px] md:gap-[20px] text-[16px] font-normal text-white font-["Open Sans"] leadeing-[135%]'>
                <li
                  className={`${styles.contactListV2} transition-transform duration-500 ease-in-out flex gap-[7px] w-fit hover:duration-500`}
                >
                  <svg
                    width="14"
                    height="12"
                ...
                <li
                  className={`${styles.contactList} transition-transform duration-500 ease-in-out flex gap-[7px] w-fit hover:duration-500`}
                >
                  <svg
                    className="mx-auto my-auto"
                    fill="#FFFFFF"
                ...
                >
                  <svg
                    className="-ml-[3px] mr-auto my-auto"
                    width="21"
                    height="21"
                    viewBox="0 0 21 21"
                    fill="white"
        ...
        <div className="max-w-[1172px] w-full mx-auto px-4 mb-[8px] z-20">
          <div className="flex flex-col flex-col-reverse items-center md:flex-row  md:flex-nowrap justify-between text-[14px] font-normal text-footerText font-['Open Sans'] leadeing-[155%]">
            <div>
